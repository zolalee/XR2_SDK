...
rtn =XR2.CM_GetJointCtrlMode(1,CtrlMode);
cout << " the control mode for sca  1 = " << CtrlMode << endl;
...
// {   
//  start =clock();
//         cout<<"the time for start  motion ="<<start<<endl;   
//     for(j=0;j<12;j++)
//     {   
//         printf("the joint %d is %f  \n", j, testjoint[i*12+j]);
//         rtn =XR2.CM_SetJointPos(j+1,testjoint[i*12+j]);
//          //rtn =XR2.CM_GetJointPos(j+1,value);
//         //printf("the get joint %d is %f  \n", j, value); 
...
//     //     rtn =XR2.CM_SetJointPos(j+1,testjoint[i*12+j]);
//     //     end =clock();
//     //     cout<<"the time for one  motion ="<<end-start<<endl;
...
//     usleep(5000);
//     end =clock();
//      cout<<"the time for end  motion ="<<end<<endl;   
//     cout<<"the time for one  motion ="<<end-start<<endl;
//     sumtime+=(end-start);
//     printf("the action %d  is done \n", i);
    
    
//     //sumtime+=(end-start);
// }
// }
// cout<<"the time for total motion ="<<sumtime/5000<<endl;


// cout << " end for test joint test " << endl;
// sleep (2);
// for(i=0;i<12;i++)
